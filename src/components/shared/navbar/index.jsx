...
export default function Navbar() {
  ...
  return (
    ...
    `}
              >
                <div className="bg-white border shadow-xl min-w-100 max-h-96 overflow-y-auto p-4 grid grid-cols-2 md:grid-cols-3 gap-y-6">
                  {brands.length === 0 ? (
                    ...
                    brands.map((brand) => (
                      <Link
                        ...
                        className="hover:text-gray-600 text-black block text-sm font-medium"
